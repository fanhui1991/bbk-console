...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("fanhui");
        dsc.setPassword("1314fan.");
        ...
        pc.setParent(null);
        pc.setEntity("com.bookie.guns.common.persistence.model");
        pc.setMapper("com.bookie.guns.common.persistence.dao");
        pc.setXml("com.bookie.guns.common.persistence.dao.mapping");
