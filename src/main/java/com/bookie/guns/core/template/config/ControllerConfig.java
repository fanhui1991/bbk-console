...
public class ControllerConfig {
    ...
    public void init() {
        ...
        this.packageName = "com.bookie.guns.modular." + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\com\\bookie\\guns\\modular\\" + contextConfig.getModuleName() + "\\controller\\{}Controller.java";
    }
