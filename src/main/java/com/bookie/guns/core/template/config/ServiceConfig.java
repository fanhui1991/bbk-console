package com.bookie.guns.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        this.servicePathTemplate = "\\src\\main\\java\\com\\bookie\\guns\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\bookie\\guns\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.bookie.guns.modular." + contextConfig.getModuleName() + ".service";
    }
